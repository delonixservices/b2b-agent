...
export default function HotelsPage() {
  ...
  const getGuestDisplayText = () => {
    const { adults, children } = guestInfo
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative" style={{zIndex: 1}}>
          ...
          <div className="bg-white p-8 rounded-lg shadow-lg mt-12" style={{paddingTop: '3.5rem'}}>
            ...
            <div className="flex justify-center mt-2">
              <button className="bg-blue-500 text-white text-2xl font-bold py-3 px-20 rounded-full shadow hover:bg-blue-600 transition uppercase tracking-wide">SEARCH</button>
            </div>
          </div>
        </div>
      </div>
