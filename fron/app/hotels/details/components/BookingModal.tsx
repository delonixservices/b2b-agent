...
export default function BookingModal({
  ...
  const [step, setStep] = useState<'policy' | 'guest-info' | 'confirmation'>('policy')
            ...
            <div>
              <div className="mb-6">
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                  <p><strong>Room:</strong> {selectedPackage.room_details?.room_type || 'Standard Room'}</p>
                  <p><strong>Price:</strong> {formatPrice(selectedPackage.chargeable_rate || 0)}</p>
                  <p><strong>Meal Plan:</strong> {selectedPackage.room_details?.food || 'Room Only'}</p>
                </div>
              </div>
          ...
          {step === 'confirmation' && (
            <div className="text-center">
              <div className="mb-6">
                ...
                <h3 className="text-xl font-semibold text-gray-800 mb-2">Pre-booking Successful!</h3>
                <p className="text-gray-600">Your booking request has been processed. You will receive a confirmation email shortly.</p>
              </div>
