...
import { User, Building, Users, LogOut, BarChart2, CreditCard, Hotel, FileText, List, Percent, UserPlus, Repeat } from 'lucide-react'
      ...
      <div className="flex flex-1">
        ...
        <aside className="hidden md:flex flex-col w-64 bg-white shadow-lg py-8 px-4 fixed h-full z-40">
          ...
          <nav className="flex flex-col gap-4">
            ...
            <button onClick={() => router.push('/dashboard/NewUsers')} className="flex items-center gap-3 px-4 py-2 rounded-lg hover:bg-blue-50 text-gray-700 font-medium">
          ...
          <div className="pt-20 pb-16 px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex justify-center mb-8">
              <div className="relative w-full max-w-xl rounded-lg overflow-hidden shadow-lg">
                <img src="/hotel-cta-bg.jpg" alt="Book Hotel" className="absolute inset-0 w-full h-full object-cover opacity-80" />
