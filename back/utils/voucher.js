 ...
 */
const generateVoucher = async (bookingData) => {
  try {
...
Email: ${bookingData.contactDetail?.email || 'N/A'}
Mobile: ${bookingData.contactDetail?.mobile || 'N/A'}
...
Generated on: ${new Date().toISOString()}
    ...
    return Buffer.from(voucherContent, 'utf8');
  } catch (error) {
